...
data=load('C:\\Users\\zhongyuan\\Desktop\\origin\\7meters_371 - Copy.txt');
configurations=data;
...
% generate path
testPath=configurationsToDubinsPath(configurations,7);
L = 0;
for i = 1:size(testPath,2)
    L = L+testPath(i).length;
end
