...
for pre = 5:5:50
    ...
    for dix = 1:30
        %%read tsp points
        filename = sprintf('C:\\Users\\zhongyuan\\Desktop\\dataIII_30x30\\tsp%d_%d.tmp', pre, dix);
        ...
        filename=sprintf('C:\\Users\\zhongyuan\\Desktop\\dataIII_30x30\\output_tsp%d_%d.txt', pre, dix);
        fid = fopen(filename, 'r');
        for i = 1:6
            tline = fgetl(fid);
        end
...
filename=sprintf('C:\\Users\\zhongyuan\\Desktop\\dataIII_30x30\\output_tsp_com_aia_aa.txt');
...
filename=sprintf('C:\\Users\\zhongyuan\\Desktop\\dataIII_30x30\\output_tsp_com_aa.txt');
...
filename=sprintf('C:\\Users\\zhongyuan\\Desktop\\dataIII_30x30\\output_tsp_aa.txt');
...
filename=sprintf('C:\\Users\\zhongyuan\\Desktop\\dataIII_30x30\\output_tsp.txt');
...
filename=sprintf('C:\\Users\\zhongyuan\\Desktop\\dataIII_30x30\\output_tsp_com.txt');
...
filename=sprintf('C:\\Users\\zhongyuan\\Desktop\\dataIII_30x30\\output_tsp_com_aia.txt');
...
for pre = 5:5:50
    ...
    for dix = 1:30
        %%read tsp points
        filename = sprintf('C:\\Users\\zhongyuan\\Desktop\\dataI_5x5\\tsp%d_%d.tmp', pre, dix);
        fid = fopen(filename, 'r');
        for i = 1:6
            tline = fgetl(fid);
        end
        ...
        %%read output result sequence
        filename=sprintf('C:\\Users\\zhongyuan\\Desktop\\dataI_5x5\\output_tsp%d_%d.txt', pre, dix);
        fid = fopen(filename, 'r');
        for i = 1:6
            tline = fgetl(fid);
        end
...
filename=sprintf('C:\\Users\\zhongyuan\\Desktop\\dataI_5x5\\output_tsp_com_aia_aa.txt');
save(filename,'results_tsp_com_aia_aa','-ascii');
...
filename=sprintf('C:\\Users\\zhongyuan\\Desktop\\dataI_5x5\\output_tsp_com_aa.txt');
save(filename,'results_tsp_com_aa','-ascii');
...
filename=sprintf('C:\\Users\\zhongyuan\\Desktop\\dataI_5x5\\output_tsp_aa.txt');
save(filename,'results_tsp_aa','-ascii');
...
filename=sprintf('C:\\Users\\zhongyuan\\Desktop\\dataI_5x5\\output_tsp.txt');
save(filename,'results_tsp','-ascii');
...
filename=sprintf('C:\\Users\\zhongyuan\\Desktop\\dataI_5x5\\output_tsp_com.txt');
save(filename,'results_tsp_com','-ascii');
...
filename=sprintf('C:\\Users\\zhongyuan\\Desktop\\dataI_5x5\\output_tsp_com_aia.txt');
save(filename,'results_tsp_com_aia','-ascii');
