...
configurations=[20.8571   14.0000   -0.5708    0.7500;
    4.8571   14.0000   -2.5708    0.7500];

% configurations=[14.9521,15.6903,-1.2365,0.75;
%         13.8694,18.1667,4.1267,0.75;]

% configurations=[402773.2933202142,4369600.840308357,0,0.75;
%         402772.19415053545,4369606.738770894,-1.57,0.75;]
    
% generate path
testPath=configurationsToDubinsPath(configurations,15);

circ = ppCircle(10,15,5,false,true);
[xout,yout,hout]=dubinsCircleIntersection(testPath,circ)
